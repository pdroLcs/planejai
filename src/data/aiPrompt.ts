...
const RESPONSE_SCHEMA = `{
  "feasibility": {
    "status": "viable" | "needs_adjustment" | "unfesible",
...
export const buildAIPrompt = (simulation: SimulationRecord) => {
  ...
  return `Você é um educador financeiro especializado em finanças pessoais.
          ...
          voltado para pessoas sem conhecimento financeiro. O diagnóstico será exibido diretamente ao usuário no app, fale sempre
          em segunda pessoa ("você tem...", "sua meta...").
